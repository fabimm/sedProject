...
<center><button onclick="document.getElementById('id01').style.display='block'" style="width:175px;">Registrarse</button></center>

<center><button onclick="location.href='index.php'" style="width:175px;">Inicio</button></center>
