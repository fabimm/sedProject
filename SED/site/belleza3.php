...
<html class="wide wow-animation" lang="en">
  <head>
    <!-- Site Title-->
    <title>Trucos sencillos para eliminar las ojeras</title>
      ...
      <section class="breadcrumbs-custom">
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <p class="breadcrumbs-custom__title">Belleza: Luce una mirada más jóven.</p>
          </div>
        </div>
      </section>
      <section class="section-xxl text-center bg-image-6">
        <div class="container nonstandart-post-header"><img class="img-circle" src="images/timeline-1-109x109.jpg" alt="" width="109" height="109"/>
          <p class="heading-4">José Aldana</p>
          <h2>Trucos sencillos para eliminar las ojeras</h2>
          <div class="post-meta">
            <div class="group">
              <div class="icon-list-wrap icon icon-gray linear-icon-clock3"><a>
                  <time datetime="2017">Oct. 30, 2018  </time></a></div>
            </div>
          </div>
          ...
          <div class="row row-60 justify-content-sm-center">
            <div class="col-lg-8 section-divided__main">
              <div class="section-sm post-single-body">
                ...
                <img src="images/about-1-886x668.jpg" alt="" width="886" height="668"/>
        ...
        <div class="container">
          <div class="row justify-content-sm-center">
            <div class="col-md-10 col-xl-6">
              ...
              <p class="rights"><span>Beaurt & Health</span><span>&nbsp;</span><span>©</span><span>&nbsp;</span><span class="copyright-year"></span>.</p>
            </div>
          </div>
        </div>
      </footer>
