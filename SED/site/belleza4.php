...
<html class="wide wow-animation" lang="en">
  <head>
    <!-- Site Title-->
    <title>Cómo lograr un contour natural</title>
      ...
      <section class="breadcrumbs-custom">
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <p class="breadcrumbs-custom__title">Belleza: Contornea tu rostro de la mejor manera.</p>
          </div>
        </div>
      </section>
      <section class="section-xxl text-center bg-image-6">
        <div class="container nonstandart-post-header"><img class="img-circle" src="images/fabimayen-belleza1.jpg" alt="" width="109" height="109"/>
          <p class="heading-4">Fabi Mayén</p>
          <h2>Cómo lograr un contour natural</h2>
          <div class="post-meta">
            <div class="group">
              <div class="icon-list-wrap icon icon-gray linear-icon-clock3"><a>
                  <time datetime="2017">Feb. 28, 2018  </time></a></div>
            </div>
          </div>
